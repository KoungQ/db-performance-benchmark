...
function event()
  con:query([[
    SELECT r.room_no, r.title, r.room_type, r.room_status, r.residence_period,
           r.capacity, r.current_mate_count, c.checklist_no, c.bedtime, c.wake_up,
           c.return_home, c.return_home_time, c.cleaning, c.phone_call, c.sleep_light,
           c.sleep_habit, c.snoring, c.shower_time, c.eating, c.lights_out,
           c.lights_out_time, c.home_visit, c.smoking, c.refrigerator,
